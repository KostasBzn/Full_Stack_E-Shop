...
const EditProduct = () => {
  ...
  const { updateProduct, selectedProduct, errors } = useContext(ProductContext);
  ...
  useEffect(() => {
    if (selectedProduct) {
      ...
      setFullDescription(selectedProduct.fullDescription);
    ...
    <div className="max-w-md mt-10 mx-auto bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="flex items-center justify-center">
          ...
          <button
            className="bg-customColor  text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline"
            type="submit"
          >
            Update Product
          </button>
